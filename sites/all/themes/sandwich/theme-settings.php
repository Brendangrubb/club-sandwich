 ...
 */
function sandwich_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['sandwich_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('sandwich sample setting'),
  '#default_value' => theme_get_setting('sandwich_example'),
